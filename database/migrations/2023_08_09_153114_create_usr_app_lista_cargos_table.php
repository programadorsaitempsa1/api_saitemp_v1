...
class CreateUsrAppListaCargosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('usr_app_lista_cargos', function (Blueprint $table) {
            $table->id();
            $table->string('nombre');
    ...
    {
        Schema::dropIfExists('usr_app_lista_cargos');
    }
}
