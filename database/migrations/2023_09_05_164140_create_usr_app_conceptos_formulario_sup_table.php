...
class CreateUsrAppConceptosFormularioSupTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('second_db')->create('usr_app_conceptos_formulario_sup', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('second_db')->dropIfExists('usr_app_conceptos_formulario_sup');
    }
}
