...
class CreateUsrAppMiembrosJuntaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('usr_app_miembros_junta', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('usr_app_miembros_junta');
    }
}
